...
SECRET_KEY = os.environ.get('SECRET_KEY', '#i2dq2ycd2%0nd$tbnplp=0-v4ie%hjey^w@x7ppjpe6j8^dfh')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = 'DEVELOPMENT' in os.environ

ALLOWED_HOSTS = ['new-dawn-fitness.herokuapp.com', 'localhost']

CSRF_TRUSTED_ORIGINS = ['https://8000-colinshaw1-newdawnfitne-e59xqb4h7ch.ws-eu74.gitpod.io/']
...
if 'USE_AWS' in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'new-dawn-fitness'
...
DEFAULT_FROM_EMAIL = 'newdawnfitness@example.com'
